                ...
                >
                  ...
                  <div className="flex gap-1 flex-wrap">
                    <span className="text-xs px-2 py-0.5 rounded-full bg-blue-50 text-blue-700">
                      Det {Math.round(m.confianza * 100)}%
                    </span>
                    {m.vacas?.id_negocio && (
                  ...
                  <div className="mt-2 h-1 rounded-full bg-gray-100 overflow-hidden">
                    <div className="h-full rounded-full bg-green-500" style={{ width: `${Math.round(m.confianza * 100)}%` }} />
                  </div>
                </div>
              ))}
            </div>
              ...
              {!selected ? (
                ...
                <>
                  <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                    ...
                    <div className="p-3">
                      <div className="relative w-full h-52 bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center">
                        {selected.frames_formateados?.ruta_archivo ? (
                          <img
                        ...
                        {showBbox && selected.bbox_monta && (() => {
                          try {
                            const b = JSON.parse(selected.bbox_monta)
                            return (
                              <div
                                className="absolute border-2 border-red-400 rounded"
                                style={{ left: `${b[0]}px`, top: `${b[1]}px`, width: `${b[2]}px`, height: `${b[3]}px` }}
                              >
                                <span className="absolute -top-5 left-0 bg-red-400 text-white text-xs px-1 rounded">
                                  Monta {selected.confianza.toFixed(2)}
                                </span>
                              </div>
                            )
                          } catch { return null }
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-gray-50 rounded-lg p-3">
                              ...
                              <div className="text-sm font-medium text-gray-900 mt-0.5">
                                {Math.round(selected.confianza * 100)}%
                              </div>
                            </div>
                          </div>
                        </>
